...
func (in *PlugSpec) DeepCopyInto(out *PlugSpec) {
	*out = *in
	...
	if in.Resources != nil {
		...
		*out = make([]*PlugSpecResource, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PlugSpecResource)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlugSpecResource) DeepCopyInto(out *PlugSpecResource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlugSpecResource.
func (in *PlugSpecResource) DeepCopy() *PlugSpecResource {
	if in == nil {
		return nil
	}
	out := new(PlugSpecResource)
...
func (in *SocketSpec) DeepCopyInto(out *SocketSpec) {
	*out = *in
	...
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = make([]*SocketSpecResource, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SocketSpecResource)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SocketSpecResource) DeepCopyInto(out *SocketSpecResource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SocketSpecResource.
func (in *SocketSpecResource) DeepCopy() *SocketSpecResource {
	if in == nil {
		return nil
	}
	out := new(SocketSpecResource)
