...
func (in *IntegrationSocketSpec) DeepCopyInto(out *IntegrationSocketSpec) {
	*out = *in
	...
	if in.Replications != nil {
		...
		*out = make([]*IntegrationSocketSpecReplication, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(IntegrationSocketSpecReplication)
				**out = **in
			}
		}
	}
	in.Job.DeepCopyInto(&out.Job)
	in.CleanupJob.DeepCopyInto(&out.CleanupJob)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IntegrationSocketSpecReplication) DeepCopyInto(out *IntegrationSocketSpecReplication) {
	*out = *in
	out.from = in.from
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IntegrationSocketSpecReplication.
func (in *IntegrationSocketSpecReplication) DeepCopy() *IntegrationSocketSpecReplication {
	if in == nil {
		return nil
	}
	out := new(IntegrationSocketSpecReplication)
