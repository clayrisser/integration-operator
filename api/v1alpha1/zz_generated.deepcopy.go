...
func (in *IntegrationPlugSpec) DeepCopyInto(out *IntegrationPlugSpec) {
	*out = *in
	...
	if in.MergeConfigmaps != nil {
		in, out := &in.MergeConfigmaps, &out.MergeConfigmaps
		*out = make([]*IntegrationPlugSpecMergeConfigmaps, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.MergeSecrets != nil {
		in, out := &in.MergeSecrets, &out.MergeSecrets
		*out = make([]*IntegrationPlugSpecMergeSecrets, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationFrom) DeepCopyInto(out *ReplicationFrom) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicationFrom.
func (in *ReplicationFrom) DeepCopy() *ReplicationFrom {
	if in == nil {
		return nil
	}
	out := new(ReplicationFrom)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationTo) DeepCopyInto(out *ReplicationTo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicationTo.
func (in *ReplicationTo) DeepCopy() *ReplicationTo {
	if in == nil {
		return nil
	}
	out := new(ReplicationTo)
	in.DeepCopyInto(out)
	return out
}
